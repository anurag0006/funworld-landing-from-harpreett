...
export const RazorpayCheckout = async ({
  ...
  try {
    ...
    var options = {
      ...
      // callback_url: `http`,
      // callback_url: `http://localhost:3000/api/razorpay/paymentverification?id=${ticketId}&price=${checkoutPriceAfterDiscount}&discount=${discountPrice}&coupon_code=${coupon}`,
      prefill: {
